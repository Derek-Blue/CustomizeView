...
@SuppressWarnings("UnusedDeclaration")//忽略未使用提醒
public class myImageView extends ImageView {
    ...
    public myImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //設定可自定義屬性，屬性格式在valuse->attrs.xml
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setTextSize(35);//設定要繪製的文字大小
        canvas.drawText("Hdodenhof's", 130, 100, paint);// 用畫筆在畫布上添加文字，中間兩個參數對應的是座標。
        canvas.drawText("CircleImageView", 110, 140, paint);// 用畫筆在畫布上添加文字，中間兩個參數對應的是座標。
    }
